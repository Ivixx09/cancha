...
const Section3 = () => {
  return (
    <div className="text-center my-8">
      {/* Title */}
      <h2 className="text-4xl pb-4 font-black mb-6">Digitize your complex</h2>
