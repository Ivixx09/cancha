...
const Section4 = () => {
  return (
    <div className="text-center my-8 flex flex-col items-center bg-gradient-to-b from-gray-800 to-gray-500">
      {/* Image */}
      <img src="/images/calendar.png" alt="Center Image" className="mx-auto h-[10vh] " />

      {/* Text Below Image */}
      <div className='flex flex-col items-center'>
        <p className="text-3xl text-white font-bold">$8,710 per month</p>
        <p className="text-xl text-white">Try it <span className='text-3xl font-bold'>FREE for 1 MONTH</span> and jump into the digital age</p>
